                        ...
                        <div className="col-lg-12">
                            <form>
                                <div className="row g-3" style={{ width: '1200px', paddingRight: '560px' }}>
                                    ...
                                    <div className="col-md-6">
                                        <label htmlFor="depart">Depart<span className='req'>*</span></label>
                                        <input type="date" className="form-control" id="depart" placeholder="Select Departure Date" style={greyBorderStyle} value={departDate} onChange={(e) => setDepartDate(e.target.value)} />
                                        {validationMessages.depart && (
                                            <div className="text-danger">{validationMessages.depart}</div>
                                        )}
                                    </div>
                                    {tripType === 'returnTrip' && (
                                        <div className="col-md-6">
                                            <label htmlFor="return">Return</label>
                                            <input type="date" className="form-control" id="return" placeholder="Select Return Date" style={greyBorderStyle} value={returnDate} onChange={(e) => setReturnDate(e.target.value)} />
                                            {validationMessages.return && (
                                                <div className="text-danger">{validationMessages.return}</div>
                                            )}
                                        </div>
